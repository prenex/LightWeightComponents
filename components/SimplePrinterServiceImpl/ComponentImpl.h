...
// Here we can just include things as usual
#include<cstdio>

/* Is ensured: #include "../PrinterService.h"*/
...
namespace SimplePrinterServiceImpl {
	...
	public:
		...
		/** You can even inline functions and they will get inlined */
		virtual inline void print(int num) override {
			printf("Number: %d\n", num);
		}
	};
}
...
template<> class lwc2_inject<Printer::Service> : public SimplePrinterServiceImpl::ComponentImpl {};
#endif // PRINTER_SERVICE_INJECT

#endif // -SIMPLE_PRINTER_SERVICE_IMPL_H
